	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<a href="#" class="brand-link"> 
				...
				<span class="brand-text font-weight-light">DDIT notice</span>
			</a>
						...
						<form class="card card-primary" method="post" action="/notice/insert.do" id="noticeForm">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input type="text" id="noticeTitle" class="form-control" name="noticeTitle" value="${notice.noticeTitle }" placeholder="제목을 입력해주세요">
								</div>
								<div class="form-group">
									<label for="inputDescription">내용을 입력해주세요</label>
									<textarea id="noticeContent" class="form-control" rows="14" name="noticeContent">${notice.noticeContent }</textarea>
								</div>
								<div class="row">
									<div class="col-12">
