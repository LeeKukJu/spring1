					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item">
							<a href="#" class="nav-link"> 
								...
								<p>공지사항 <i class="right fas fa-angle-left"></i></p>
							</a>
						</li>
					</ul>
				</nav>
						...
						<div class="col-md-12">
							<div class="card card-primary">
								<div class="card-header">
									...
									<div class="card-tools">${notice.noticeWriter } | ${notice.noticeDate } | ${notice.noticeHit }</div>
								</div>
...
$(function(){
	...
	updateBtn.on("click", function(){
		// 수정은 noticeNo를 함께 보내서 수정 폼으로 넘어가야한다.
		// noticeNo를 함께 보내는 기능 중, 삭제도 공통사항이므로 공통 form을 함께 공유한다.
		nFrm.submit();
	});
